...
const SlicerItems = ({
  ...
  return slicers?.map((item, idx) => (
    <div
      key={idx}
      className="w-full flex flex-col items-start gap-[2px] pl-5 text-[hsl(0,0,30%)] dark:text-white"
    >
...
const CheckSlicer = ({
  ...
  return (
    <div className="w-[calc(100%-0.4rem)] h-[calc(100%-0.4rem)] flex flex-row overflow-scroll p-1 table_body">
      <div
        className={`absolute p-[2px] -right-4 top-10 z-[2] bg-gray-400 dark:bg-gray-700 cursor-pointer ${
          isMainHovered?.[selectedItem] ? "opacity-60" : "opacity-0"
        }`}
        onClick={() => {
          // setSlicersCheckedItems({});
      ...
      <div className="flex flex-col w-full gap-[2px]">
        <p
          className="text-[10px] font-[900] px-2 pt-2 text-[hsl(0,0,0%)] dark:text-white"
          style={{
          ...
          >
            <div className="w-full flex flex-row items-center gap-1">
              ...
              <div className="w-full overflow-ellipsis whitespace-nowrap overflow-hiddens">
                <p
                  className="text-[10px] text-[hsl(0,0,30%)] dark:text-white overflow-ellipsis whitespace-nowrap overflow-hidden"
                  style={{
                    fontSize: `${dataFontSize}px`,
                    fontWeight: dataFontWeight,
                  }}
