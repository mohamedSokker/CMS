...
const Chatbot = () => {
  ...
  return (
    <div
      className="w-[500px] h-[250px] bg-gray-300 dark:bg-gray-700 absolute flex flex-col justify-between items-center left-[45px] bottom-[5px] z-[2000]"
      style={{
    ...
    >
      <div
        className="w-full p-2 cursor-pointer flex flex-row justify-end text-black dark:text-white opacity-50"
      ...
      >
        <form
          className="w-full h-full bg-white dark:bg-gray-900 rounded-[6px] flex flex-row justify-between items-center px-1"
          style={{
        ...
        >
          <textarea
            className="rounded-[6px] outline-none h-full p-1 pr-4 flex flex-grow dark:bg-gray-900"
            style={{
              padding: isChatbot ? "4px" : "0px",
              resize: "none",
            }}
          ...
          />
          <div
            className="flex flex-row justify-end items-center h-full cursor-pointer text-gray-600 dark:text-gray-400"
            style={{
