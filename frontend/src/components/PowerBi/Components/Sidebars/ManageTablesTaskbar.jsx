    ...
    <div className="w-full h-[78px]">
      <div className="flex flex-row justify-start items-center text-[12px] gap-x-4 p-1 h-[42px]">
        <TooltipComponent content={"Add Table"} position="BottomCenter">
          <div
            className="cursor-pointer bg-gray-200 dark:bg-gray-700 rounded-md p-1 px-2 text-logoColor dark:text-white flex flex-col justify-center items-center"
            onClick={() => {
              setTablesData((prev) => ({
                ...prev,
        ...
        <TooltipComponent content={"Add Column"} position="BottomCenter">
          <div
            className="cursor-pointer bg-gray-200 dark:bg-gray-700 dark:text-white rounded-md p-1 px-2 text-logoColor flex flex-col justify-center items-center"
            onClick={() => {
              if (activeItem !== "") {
        ...
        <div
          className="cursor-pointer bg-gray-200 dark:bg-gray-700 dark:text-white rounded-md px-2 py-[2px] text-logoColor text-[10px]"
          onClick={() => {}}
        >
          <FormalDropdown
            // label={"Type"}
      ...
      <div className="flex flex-row gap-2 justify-center items-center w-full p-1 h-[36px] relative dark:bg-gray-800 dark:text-white">
        <div className="flex flex-grow dark:bg-gray-700 dark:text-white">
          ...
          >
            <input
              ref={inputRef}
              className="text-[12px] w-full border border-gray-200 dark:border-gray-700 outline-none p-1 pl-3 dark:bg-gray-800 dark:text-white"
              value={inputValue}
              onChange={(e) => {
        ...
        {/* <div className="rounded-[4px] bg-gray-300 dark:bg-gray-800 h-full flex justify-center items-center px-2 cursor-pointer">
