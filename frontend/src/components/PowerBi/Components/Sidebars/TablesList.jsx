...
const TablesList = () => {
  ...
  return isOpenPanel ? (
    <div
      className="flex w-[200px] h-full flex-col border-l-[1px] overflow-y-scroll bg-gray-300 p-2 relative z-[1] dark:bg-gray-700 dark:border-gray-600"
      style={{
    ...
    >
      <div className="w-full">
        <div className="w-full flex flex-row justify-between p-1">
          <p className="text-[12px] font-[800] dark:text-white">Data</p>
          <div
            className="cursor-pointer text-gray-600 dark:text-gray-400 dark:hover:text-gray-100 hover:text-gray-900"
            onClick={handleClick}
          >
      ...
      <div className="w-full p-1 relative z-[9]">
        <div className="w-full bg-gray-300 overflow-x-scroll flex flex-col gap-2 p-2 dark:bg-gray-700">
          {isDataReady ? (
            [
              ...selectedTable,
              ...selectedRelationshipsTable,
              ...
              <TooltipComponent key={idx} content={item} position="LeftTop">
                <div className="flex flex-col w-full gap-1">
                  <div
                    className={`w-full flex flex-row justify-start items-center rounded-[4px] text-[12px] cursor-pointer overflow-hidden pr-[22px] ${
                      activeItem === item
                        ? "bg-[#CB1955] text-white"
                  ...
                  >
                    {renamedItem === item ? (
                      ...
                      >
                        <input
                          className="text-[12px] w-full outline-none dark:bg-black dark:text-white"
                          ref={inputRef}
                          value={RenamedName}
                          onChange={(e) => {
                      ...
                      <div className="w-full flex flex-row justify-start items-center cursor-pointer h-full">
                        {isPanelDown?.[item] ? (
                          <div
                            className={`p-1 cursor-pointer flex items-center h-full ${
                              activeItem === item
                                ? "bg-[#CB1955] text-white"
                                : "bg-white text-black dark:bg-gray-800 dark:text-white"
                            }`}
                        ...
                        >
                          ...
                          <p className="w-full overflow-ellipsis whitespace-nowrap overflow-hidden p-1 dark:text-white">
                          ...
                          >
                            ...
                            >
                              {renamedColItem === col ? (
                                ...
                                >
                                  <input
                                    className="w-full outline-none p-1 rounded-[4px] text-[10px] bg-white text-gray-700 dark:bg-gray-900 dark:text-white"
                                    ref={inputColRef}
                                ...
                                >
                                  ...
                                  <div className="w-[50%] p-1 rounded-[4px] text-[10px] flex flex-row gap-2 items-center overflow-ellipsis whitespace-nowrap overflow-hidden dark:text-white">
    ...
    <div
      className="flex flex-col h-full justify-start items-center gap-8 bg-gray-300 dark:bg-gray-700 text-gray-800 dark:text-gray-200 transition-all duration-500 ease-in-out"
      style={{
    ...
    >
      ...
      <div
        className="text-black font-[800] text-[12px] dark:text-white"
