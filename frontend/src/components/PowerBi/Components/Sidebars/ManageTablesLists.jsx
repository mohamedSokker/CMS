...
const ManageTablesLists = ({ setTableLoading }) => {
  ...
  return (
    <div className="flex w-[200px] h-full flex-col bg-gray-300 dark:bg-gray-700 border-l-[1px] overflow-y-scroll p-2 gap-2">
          ...
          <TooltipComponent key={idx} content={item} position="LeftTop">
            <div className="flex flex-col w-full gap-1">
              <div
                ...
                // className="w-full flex flex-row justify-start items-center bg-white dark:bg-gray-700 rounded-[4px] text-[12px] dark:text-white cursor-pointer pr-[22px] relative"
                // style={{
              ...
              >
                {renamedItem === item ? (
                  ...
                  >
                    <input
                      className="text-[12px] w-full outline-none bg-white text-gray-700 dark:bg-gray-900 dark:text-white"
                      ref={inputRef}
                      value={RenamedName}
                      onChange={(e) => {
                          ...
                          <div
                            className={`w-full flex flex-row gap-1 items-center px-1 rounded-[4px] relative overflow-ellipsis whitespace-nowrap overflow-hidden ${
                              activeColItem[item] === col
                                ? "bg-[#CB1955] text-white border-[1px] border-[#CB1955]"
                                : "bg-white dark:bg-gray-600 text-black dark:text-white border-[0px] border-transparent"
                            }`}
                            onClick={() => {
                              setTableLoading(true);
                              setTimeout(() => {
