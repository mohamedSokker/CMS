...
const AddActions = ({ setIsActionCard }) => {
  ...
  return (
    ...
    >
      ...
      ></div>
      <div
        className={`md:w-[30%] w-[30%] aspect-square flex flex-col justify-between items-center bg-white dark:bg-gray-800 dark:text-white relative z-[1001] mainContent overflow-y-scroll`}
        style={{
            ...
            <div className="w-full flex flex-col justify-start gap-1">
              ...
              <div className="w-full flex flex-col gap-1 justify-start items-start text-[10px]">
                {Object.keys(savedTablesData)?.map((table) => (
                  <div
                    key={table}
                    className="p-1 py-[6px] bg-gray-50 dark:bg-gray-700 dark:border-gray-500 w-[100%] flex flex-col items-center justify-between border rounded-[4px] hover:cursor-pointer overflow-ellipsis whitespace-nowrap overflow-hidden"
                    // style={{
              ...
              <div className="w-full flex flex-col gap-1 justify-start items-start text-[10px]">
                {Object.keys(savedTablesData)?.map((table) => (
                  <div
                    key={table}
                    className="p-1 py-[6px] bg-gray-50 dark:bg-gray-700 w-[100%] dark:border-gray-500 flex flex-col items-center justify-between border rounded-[4px] hover:cursor-pointer overflow-ellipsis whitespace-nowrap overflow-hidden"
                    // style={{
                            ...
                            >
                              <div
                                className={`w-full flex flex-row items-center justify-between overflow-ellipsis whitespace-nowrap overflow-hidden rounded-sm pl-1 ${
                                  isSortChecked?.[table]?.includes(col)
