  ...
  return (
    ...
    >
      <div className="w-full h-full flex flex-row relative">
        {sidebarPreview && <Chatbot />}
        {sidebarPreview && <ToolsSIdebar />}

        <MainArea sidebarPreview={sidebarPreview} />

        {/* {<Properties />} */}

        {sidebarPreview && <Visualization />}

        {sidebarPreview && <TablesList />}
      </div>
    </div>
  );
};
