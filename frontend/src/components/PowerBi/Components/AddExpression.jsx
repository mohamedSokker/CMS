...
const AddExpression = ({ setIsExpressionCard }) => {
  ...
  return (
    ...
    >
      ...
      ></div>
      <div
        className={`md:w-[25%] w-[25%] aspect-square flex flex-col justify-between items-center bg-white dark:bg-gray-800 dark:text-white relative z-[1001] mainContent overflow-y-scroll`}
        style={{
